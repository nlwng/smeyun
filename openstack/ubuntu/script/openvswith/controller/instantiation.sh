...
#创建外部网络的子网
neutron subnet-create ext-net 192.168.52.0/24 --allocation-pool start=192.168.52.50,end=192.168.52.150 --gateway 192.168.52.1 --disable-dhcp --name ext-subnet --dns-nameserver 114.114.114.114
